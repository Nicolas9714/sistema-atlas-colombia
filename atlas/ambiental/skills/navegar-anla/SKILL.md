...
- Para consultar el estado de un expediente o trámite ambiental, usar VITAL (`vital-publico.minambiente.gov.co/buscador`); GACETA (`gaceta.anla.gov.co:8443/Consultar-gaceta`) permite buscar resoluciones, permisos y autocertificados por tipo de documento y región operativa; la búsqueda en GACETA no reconoce tildes.
