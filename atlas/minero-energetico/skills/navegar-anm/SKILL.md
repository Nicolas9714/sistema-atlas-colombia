---
name: navegar-anm
description: "Guía de navegación para la ANM: catastro minero, estadísticas de producción y regalías, normograma minero y datos de formalización."
---
...
2. Consulta `fuentes.md` para acceder directamente a AnnA Minería, la Cuadrícula Minera o los datos abiertos de producción.
...
- AnnA Minería (SIGM) es la plataforma vigente del catastro; la plataforma anterior (Génesis) se mantiene activa para consulta de títulos e históricos.
- La Cuadrícula Minera es descargable en GeoJSON y GDB desde la sección de AnnA Minería, sin necesidad de login.
- El normograma está organizado por etapa del ciclo del proyecto minero, no cronológicamente, lo que facilita la consulta por fase.
