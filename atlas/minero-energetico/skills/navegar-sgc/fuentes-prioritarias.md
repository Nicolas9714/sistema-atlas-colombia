...
|---|---|---|---|
| MIIG — Mapa Interactivo de Información Geocientífica | `miig.sgc.gov.co/Paginas/advanced.aspx` | Visor interactivo de capas geocientíficas: geología, minerales, amenazas, geofísica; acceso sin login | 2026-05-30 |
| SIIG — Sistema de Información para la Investigación Geológica | `siig.sgc.gov.co/Paginas/Inicio.aspx` | Repositorio de información geológica del SGC; búsqueda por proyecto y temática | 2026-05-30 |
| SIMMA — Movimientos en Masa | `simma.sgc.gov.co/` | Sistema de Información de Movimientos en Masa; inventario nacional de eventos | 2026-05-30 |
| GeoRED — Red Geodésica | `geored2.sgc.gov.co/` | Red geodésica colombiana; datos GPS y de deformación cortical | 2026-05-30 |
| Hidrotermales | `hidrotermales.sgc.gov.co/invtermales/` | Inventario nacional de manifestaciones hidrotermales | 2026-05-30 |
| Datos Abiertos SGC | `datos.sgc.gov.co/` | Portal de datos abiertos del SGC; datasets geocientíficos descargables | 2026-05-30 |
...
|---|---|---|---|
| IDE Geocientífica | `www2.sgc.gov.co/sgc/ide-geocientifica/` | Infraestructura de Datos Espaciales del SGC; catálogo de servicios WMS/WFS | 2026-05-30 |
| Geoportal SGC | `www2.sgc.gov.co/sgc/mapas/Paginas/geoportal.aspx` | Portal de mapas del SGC; acceso a todas las capas geocientíficas publicadas | 2026-05-30 |
...
| Nombre | Frecuencia | URL o ruta | Verificado |
|---|---|---|---|
| Boletines de sismicidad | Mensual | `www2.sgc.gov.co/Publicaciones/Paginas/boletines-sismicidad.aspx` | 2026-05-30 |
| Boletines de movimiento fuerte | Por evento | `www2.sgc.gov.co/Publicaciones/Paginas/boletines-movimiento-fuerte.aspx` | 2026-05-30 |
| Sismos importantes | Por evento | `www2.sgc.gov.co/Publicaciones/Paginas/sismos-importantes.aspx` | 2026-05-30 |
| Informes técnicos | Variable | `www2.sgc.gov.co/Publicaciones/Paginas/informes-tecnicos.aspx` | 2026-05-30 |
| Revistas SGC | Periódica | `revistas.sgc.gov.co/` | Publicaciones científicas arbitradas del SGC | 2026-05-30 |
...
| Sección | Nota |
|---|---|
| `www2.sgc.gov.co` | El sitio principal del SGC está alojado en SharePoint (`www2.sgc.gov.co`); `sgc.gov.co` es la landing page de entrada; los sistemas especializados tienen subdominios propios |
