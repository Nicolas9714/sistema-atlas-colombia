...
Ruta esperada: ANM (AnnA Minería: cuadrícula y títulos) → SGC (mapa geológico MIIG y SIMMA). El tramo de restricciones ambientales vive en el Atlas Ambiental (ANAC); el enrutamiento entre atlas, en [Sistema Atlas Colombia](https://github.com/Nicolas9714/sistema-atlas-colombia).
...
Ruta esperada: ANH (mapa de tierras y normativa sectorial: contratos y áreas asignadas). Los tramos de licencias, seguimiento y monitoreo de cuencas viven en el Atlas Ambiental (ANAC); el enrutamiento entre atlas, en [Sistema Atlas Colombia](https://github.com/Nicolas9714/sistema-atlas-colombia).
